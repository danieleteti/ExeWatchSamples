...
| [DllFromOtherLanguages](DllFromOtherLanguages/)     | Can the ExeWatch **DLL SDK** really be called from languages that aren't Delphi or C++Builder? Runnable **Python ctypes** smoke test that validates all five Windows ABI axes. A full MSVC sample lives at the repo root under [`MSVCWithDLLSDK/`](../MSVCWithDLLSDK/). |
